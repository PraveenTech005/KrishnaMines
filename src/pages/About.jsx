...
const About = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-row justify-between w-full h-full items-center p-10 space-x-5 ">
        <img src={Founder} alt="Founder" className="w-2/12" />
        <div className="space-y-10 flex flex-col p-8 items-center">
          <p className="p-3 w-8/12 text-center">
          ...
          <div className="space-x-10 flex ">
            <p className="p-5 w-8/12 indent-10">
